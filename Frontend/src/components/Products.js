  ...
  return (
    ...
    className="bg-cover bg-center" style={{ backgroundImage: `url(${bg})` }}
      ...
      <div className='container h-[28rem]'>
        <div className='ml-6 py-16 flex flex-row justify-evenly'>
          <img src={Ganapathi_Pooja} alt='' width={400} />
          <div className='flex flex-col'>
            <div className='flex justify-center mr-[23rem] flex-row'>
              <h1 className='flex ml-[16rem] text-white font-bold text-xl'>
                Ganpathi Pooja
              </h1>
            ...
            <h1 className='flex justify-center gap-1 mr-[23rem] text-white'>
              <span className='font-semibold text-white'>Price:</span>Rs
              2,100.00
            </h1>
            <div className='flex flex-col w-[48rem] ml-72 bg-white border-2 rounded-lg divide-y-2 divide-y divide-zinc-800'>
            ...
            <div className='flex flex-row justify-between'>
              <div className='flex ml-[19rem] bg-white rounded-md mt-5 py-1 font-semibold px-4'>
                Pooja will be performed in Cuttack
              </div>
              <div className='ml-[15rem] text-white mt-5'>Location:</div>
              <div className='flex mr-[5rem] bg-white rounded-md mt-5 ml-2 px-2 py-1 font-semibold'>
                At My Home
              </div>
            </div>
            <div className='flex flex-row ml-[35rem] mt-5 px-3'>
      ...
      <div className='bg-white text-center ml-6 py-0 grid grid-cols-3 w-[60rem] h-[3rem] divide-x mt-24'>
        <div className='border-b-4 border-red-800'>Description</div>
        <div className=''>Reviews(3)</div>
        <div>FAQ</div>
      </div>

      <div className='bg-white flex flex-col container mt-6 h-[30rem] w-[60rem] ml-6'>
